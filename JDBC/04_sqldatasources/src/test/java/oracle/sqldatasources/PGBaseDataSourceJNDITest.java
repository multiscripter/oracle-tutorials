...
/**
 * Класс PGBaseDataSourceJNDITest тестирует работу класса PGBaseDataSourceJNDI.
 *
 ...
 * @since 2017-12-01
 */
public class PGBaseDataSourceJNDITest {
    /**
    ...
    public void checkConnectionToPostgreSQL() {
        try {
            PGBaseDataSourceJNDI pgds = new PGBaseDataSourceJNDI("localhost", "oracle_jdbc", "postgres", "postgresrootpass");
            pgds.setConnection();
